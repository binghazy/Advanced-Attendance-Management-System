      <!-- ========== Left Sidebar Start ========== -->
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="/employees" class="waves-effect <?php echo e(request()->is("employees") || request()->is("/employees/*") ? "mm active" : ""); ?>"><i class="dripicons-view-apps"></i><span>Employees List</span></a>
                                    </li>
            ...
            <!-- Left Sidebar End -->
<?php /**PATH F:\.My Projects\Databse\Attendance_Management_System\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>