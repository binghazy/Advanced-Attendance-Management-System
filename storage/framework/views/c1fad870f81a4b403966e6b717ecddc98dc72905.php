                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="font-500"><?php echo e($data[0]); ?> </h4>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="font-500"><?php echo e($data[3]); ?> %<i class="text-danger ml-2"></i></h4>
                                            <span class="peity-donut" data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72" data-height="72"><?php echo e($data[3]); ?>/<?php echo e(count($data)); ?></span>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="font-500"><?php echo e($data[1]); ?> <i class=" text-success ml-2"></i></h4>
                                            <span class="peity-donut" data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72" data-height="72"><?php echo e($data[1]); ?>/<?php echo e(count($data)); ?></span>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h4 class="font-500"><?php echo e($data[2]); ?><i class=" text-success ml-2"></i></h4>
                                            <span class="peity-donut" data-peity='{ "fill": ["#02a499", "#f2f2f2"], "innerRadius": 28, "radius": 32 }' data-width="72" data-height="72"><?php echo e($data[2]); ?>/<?php echo e(count($data)); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\.My Projects\Databse\Attendance_Management_System\resources\views/admin/index.blade.php ENDPATH**/ ?>