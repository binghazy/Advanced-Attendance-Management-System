...
<div class="topbar-left">
    <a href="/" class="logo">
        <span>
                <h1 style="color: white; ">شركة حودة</h1>
            </span>
        <i>
            <h1>A</h1>
            </i>
    ...
    <ul class="navbar-right d-flex list-inline float-right mb-0">
        ...
        <li class="dropdown notification-list d-none d-md-block">
            ...
            <div class="dropdown-menu dropdown-menu-right language-switch">
                ...
                <a class="dropdown-item" href="#"><img src="assets/images/flags/egypt_flag.png" alt="" height="16" /><span> Sharmoti </span></a>
...
<!-- Top Bar End -->
<?php /**PATH F:\.My Projects\Databse\Attendance_Management_System\resources\views/layouts/header.blade.php ENDPATH**/ ?>